      ...
      >
        ...
        <GridItem colSpan={2} pt={"35px"} pl={"220px"}>
          <Box>
            ...
            >
              <Box width={"50px"}>
                <Icon as={FaFacebookF} w={"18px"} h={"18px"} cursor={"pointer"}></Icon>
              </Box>
              <Box width={"50px"}>
                <Icon as={BsTwitter} w={"18px"} h={"18px"} cursor={"pointer"}></Icon>
              </Box>

              <Box width={"50px"}>
                <Icon as={ImInstagram} w={"18px"} h={"18px"} cursor={"pointer"}></Icon>
              </Box>
              <Box width={"50px"}>
                <Icon as={ImYoutube} w={"18px"} h={"18px"} cursor={"pointer"}></Icon>
              </Box>
              <Box width={"50px"}>
                <Icon as={FaPinterestP} w={"18px"} h={"18px"} cursor={"pointer"}></Icon>
              </Box>
            </Box>
          </Box>
        </GridItem>
